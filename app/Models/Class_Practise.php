...
class Class_Practise extends Model{
    ...
    protected $allowedFields = ['Class_class_id','Practise_practise_id','class_practise_create_time','class_practise_edit_time', 'class_practise_del_time', 'class_practise_create_class'];
