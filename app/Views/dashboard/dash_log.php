...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between m-3">
            ...
            <div class="d-flex align-items-center justify-content-center flex-wrap">
                <a class="mt-2 btn-export" href="<?= base_url('/export-log-user') ?>"><div class="d-flex justify-content-center align-items-center"><i class="fa-solid fa-file-excel icon-export"></i>Export</div></a>
